...
public class Location {
	...
	public void setLatitude(float latitude) {
	    ...
	    *            above the WGS84 ellipsoid. c can be used to indicate
	   ...
	   */
	   ...
	   public static Coordinates westCoordinateFrom(Coordinates c , double miles){
	     double latitude = c.getLatitude();
	     double startLongitude = c.getLongitude();
	     double incrementForEachMile = Math.cos(latitude) * 69;
	    // System.out.println(" incrment for each mile " + incrementForEachMile );
	     double westSideLogitude = c.getLongitude() + (  miles /incrementForEachMile);
	     Coordinates c2 = new Coordinates(latitude , westSideLogitude , Float.NaN);
	     return c2;
	   }
	   
	   public static Coordinates eastCoordinateFrom(Coordinates c , double miles){
	     double latitude = c.getLatitude();
	     double startLongitude = c.getLongitude();
	     double incrementForEachMile = Math.cos(latitude) * 69;
	    // System.out.println(" incrment for each mile " + incrementForEachMile );
	     double eastSideLongitude = c.getLongitude() - (  miles /incrementForEachMile);
	     Coordinates c2 = new Coordinates(latitude , eastSideLongitude , Float.NaN);
	     return c2;
	   }
	   
	   public static Coordinates northCoordinatesFrom(Coordinates c , double miles){
	     double longitude = c.getLongitude();
	     double startLatitude = c.getLatitude();
	    
	     double incrementForEachMile =  69;
	    // System.out.println(" incrment for each mile " + incrementForEachMile );
	     double northSideLatitude = c.getLatitude() + (  miles /incrementForEachMile);
	     Coordinates c2 = new Coordinates(northSideLatitude , longitude , Float.NaN);
	     return c2;
	   }
	   
	   public static Coordinates southCoordinateFrom(Coordinates c , double miles){
	     double longitude = c.getLongitude();
	     double startLatitude = c.getLatitude();
	    
	     double incrementForEachMile =  69;
	    // System.out.println(" incrment for each mile " + incrementForEachMile );
	     double southSideLatitude = c.getLatitude() - (  miles /incrementForEachMile);
	     Coordinates c2 = new Coordinates(southSideLatitude , longitude , Float.NaN);
	     return c2;
	   }
